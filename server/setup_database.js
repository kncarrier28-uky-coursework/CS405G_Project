...
const createItemsTableString =
  "CREATE TABLE items (itemId INT PRIMARY KEY NOT NULL AUTO_INCREMENT,itemName VARCHAR(40), category VARCHAR(40), stock INT,cost DECIMAL(38, 2),saleAmount DECIMAL(38, 2));";
