...
const item1_addString =
  'INSERT INTO items(itemId, itemName, category, stock, cost, saleAmount) VALUES (1, "Princess Doll", "Toys", 60, 2, .5)';
const item2_addString =
  'INSERT INTO items(itemId, itemName, category, stock, cost, saleAmount) VALUES (2, "Rubber Duck", "Toys", 70, 1, .2)';
const item3_addString =
  'INSERT INTO items(itemId, itemName, category, stock, cost, saleAmount) VALUES (3, "Teddy Bear", "Toys", 50, 3, .5)';
const item4_addString =
  'INSERT INTO items(itemId, itemName, category, stock, cost, saleAmount) VALUES (4, "Doll House", "Toys", 20, 6, .9)';
const item5_addString =
  'INSERT INTO items(itemId, itemName, category, stock, cost, saleAmount) VALUES (5, "Crayons", "Arts & Crafts", 50, 1, .2)';
const item6_addString =
  'INSERT INTO items(itemId, itemName, category, stock, cost, saleAmount) VALUES (6, "Toy Car", "Toys", 45, 2, .4)';
const item7_addString =
  'INSERT INTO items(itemId, itemName, category, stock, cost, saleAmount) VALUES (7, "Tricycle", "Toys", 15, 30, .45)';
const item8_addString =
  'INSERT INTO items(itemId, itemName, category, stock, cost, saleAmount) VALUES (8, "101 Tales", "Books", 30, 1, .2)';
const item9_addString =
  'INSERT INTO items(itemId, itemName, category, stock, cost, saleAmount) VALUES (9, "The Friendly Bear", "Books", 20, 1, .2)';
const item10_addString =
  'INSERT INTO items(itemId, itemName, category, stock, cost, saleAmount) VALUES (10, "Plush Dog", "Toys", 30, 3, .5)';
